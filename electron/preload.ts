...
contextBridge.exposeInMainWorld('api', {
  ...
  repo: {
    ...
    searchAll: (query: import('./providers/discoverMerge').UnifiedQuery, page?: number) =>
      ipcRenderer.invoke('repo:searchAll', query, page) as Promise<import('../src/types/repo').SavedRepo[]>,
