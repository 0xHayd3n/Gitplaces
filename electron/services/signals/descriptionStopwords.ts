...
export const STOPWORDS = new Set<string>([
  ...
  'also', 'back', 'after', 'work', 'because', 'some', 'most', 'these', 'them', 'were',
  ...
  'source', 'built', 'build', 'support', 'supports', 'feature', 'features',
  'help', 'helps', 'helper', 'helpers', 'makes', 'making', 'create', 'creates',
  'creating', 'uses', 'works', 'working', 'based',
])
