// Pure function shared between the Electron stats service and the renderer.
// The renderer reuses this to recompute the score client-side once releases
// resolve, without a second `getRepoStats` IPC round-trip.
