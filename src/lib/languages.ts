...
export const LANGUAGES: LangDef[] = [
  ...
  { name: 'Sway',       key: 'sway',        category: 'Blockchain', domainCategory: 'Specialty',       icon: null,            color: '#00f58c' },
  ...
  { name: 'Tact',       key: 'tact',        category: 'Blockchain', domainCategory: 'Specialty',       icon: null,            color: '#00b8e9' },
  { name: 'LIGO',       key: 'cameligo',    category: 'Blockchain', domainCategory: 'Specialty',       icon: null,            color: '#5c76dc' },
  { name: 'Noir',       key: 'noir',        category: 'Blockchain', domainCategory: 'Specialty',       icon: null,            color: '#d4392f' },
  { name: 'Leo',        key: 'leo',         category: 'Blockchain', domainCategory: 'Specialty',       icon: null,            color: '#00ce8b' },
  // --- Shader / GPU / Hardware ---
