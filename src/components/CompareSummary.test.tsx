...
describe('CompareSummary', () => {
  it('renders skeleton while loading', () => {
    ...
    const { container } = render(<CompareSummary owner="foo" repo="bar" base="v1.0.0" head="v1.1.0" />)
  ...
  it('renders refs, totals, and diff stats when loaded', () => {
    ...
    render(<CompareSummary owner="foo" repo="bar" base="v1.0.0" head="v1.1.0" />)
    expect(screen.getByText('v1.0.0')).toBeInTheDocument()
    expect(screen.getByText('v1.1.0')).toBeInTheDocument()
  ...
  it('renders the first-release variant without fetching when base is null', () => {
    render(<CompareSummary owner="foo" repo="bar" base={null} head="v0.1.0" />)
